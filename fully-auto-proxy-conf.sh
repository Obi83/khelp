...
apt install -y kali-linux-large kali-tools-windows-resources terminator bpytop htop shellcheck seclists inxi ufw tor curl proxychains iptables fastfetch guake impacket-scripts bloodhound powershell-empire firefox-esr
