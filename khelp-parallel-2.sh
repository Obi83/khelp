...
echo "K:::::::K    K:::::KH:::::::H     H:::::::HE::::::::::::::::::::EL:::::::::L             P::::::::::::::::P"  
echo "K:::::::K    K:::::KH:::::::H     H:::::::HE::::::::::::::::::::EL:::::::::L             P::::::PPPPPP:::::P" 
echo "K:::::::K   K::::::KHH::::::H     H::::::HHEE::::::EEEEEEEEE::::ELL:::::::LL             PP:::::P     P:::::P"
echo "KK::::::K  K:::::KKK  H:::::H     H:::::H    E:::::E       EEEEEE  L:::::L                 P::::P     P:::::P"
echo "  K:::::K K:::::K     H:::::H     H:::::H    E:::::E               L:::::L                 P::::P     P:::::P"
echo "  K::::::K:::::K      H::::::HHHHH::::::H    E::::::EEEEEEEEEE     L:::::L                 P::::PPPPPP:::::P" 
echo "  K:::::::::::K       H:::::::::::::::::H    E:::::::::::::::E     L:::::L                 P:::::::::::::PP"  
echo "  K:::::::::::K       H:::::::::::::::::H    E:::::::::::::::E     L:::::L                 P::::PPPPPPPPP"    
echo "  K::::::K:::::K      H::::::HHHHH::::::H    E::::::EEEEEEEEEE     L:::::L                 P::::P"            
echo "  K:::::K K:::::K     H:::::H     H:::::H    E:::::E               L:::::L                 P::::P"            
echo "KK::::::K  K:::::KKK  H:::::H     H:::::H    E:::::E       EEEEEE  L:::::L         LLLLLL  P::::P"            
echo "K:::::::K   K::::::KHH::::::H     H::::::HHEE::::::EEEEEEEE:::::ELL:::::::LLLLLLLLL:::::LPP::::::PP"          
...
log $LOG_LEVEL_INFO "This is an informational message." "/var/log/khelp.log"
log $LOG_LEVEL_ERROR "This is an error message." "/var/log/khelp.log"
log $LOG_LEVEL_WARNING "This is a warning message." "/var/log/khelp.log"
...
install_packages() {
    ...
    local attempts=0
    local max_attempts=3
    local packages="ufw tor curl jq iptables fail2ban sslh terminator proxychains"
