...
chown root:www-data /var/log/nginx/error.log
...
chown root:www-data /var/log/nginx/https_proxy_access.log
...
chown root:www-data /var/log/nginx/https_proxy_error.log
