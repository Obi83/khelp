...
configure_iptables() {
    ...
    # # Port 22 (SSH) - aus Sicherheitsgründen deaktiviert. Aktivieren bei Bedarf.
    # iptables -A INPUT -p tcp --dport 22 -j ACCEPT
    # log $LOG_LEVEL_INFO "Blocked SSH connections on port 22." "$IPTABLES_LOG_FILE"
    # Rate-limit new SSH connections (optional)
