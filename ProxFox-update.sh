...
install_curl() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y curl
        if [ $? -eq 0 ]; then
...
install_tor() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y tor
        if [ $? -eq 0 ]; then
...
install_ufw() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y ufw
        if [ $? -eq 0 ]; then
...
install_jq() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y jq
        if [ $? -eq 0 ]; then
...
install_iptables() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y iptables
        if [ $? -eq 0 ]; then
...
install_fail2ban() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y fail2ban
        if [ $? -eq 0 ]; then
...
install_sslh() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y sslh
        if [ $? -eq 0 ]; then
...
install_proxychains() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y proxychains
        if [ $? -eq 0 ]; then
...
install_openssl() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y openssl
        if [ $? -eq 0 ]; then
...
install_logwatch() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y logwatch
        if [ $? -eq 0 ]; then
...
install_rsyslog() {
    ...
    while [ $attempts -lt $max_attempts ]; do
        apt update -y && apt install --only-upgrade -y rsyslog
        if [ $? -eq 0 ]; then
