...
sudo chmod 644 /var/log/khelp.log
sudo chmod 644 /var/log/nginx/error.log
sudo chmod 644 /var/log/khelp_iptables.log
sudo chown root:adm /var/log/khelp.log
sudo chown root:adm /var/log/nginx/error.log
sudo chown root:adm /var/log/khelp_iptables.log
...
configure_iptables() {
    ...
    log $LOG_LEVEL_INFO "Rate-limited ICMP requests." "$IPTABLES_LOG_FILE"
