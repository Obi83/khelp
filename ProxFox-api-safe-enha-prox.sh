...
backup_config "/etc/ssl/certs/nginx-selfsigned.crt"
backup_config "/etc/ssl/private/nginx-selfsigned.key"
...
log $LOG_LEVEL_INFO "khelp script is done!" "$UPDATE_LOG_FILE"