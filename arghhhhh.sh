...
configure_ufw() {
    ...
    ufw deny 22/tcp6 comment "Deny IPv6 traffic on port 22"
    ufw deny 9050/tcp6 comment "Deny IPv6 traffic on port 9050"
    ufw deny 9001/tcp6 comment "Deny IPv6 traffic on port 9001"
    ufw deny 443/tcp6 comment "Deny IPv6 traffic on port 443"
